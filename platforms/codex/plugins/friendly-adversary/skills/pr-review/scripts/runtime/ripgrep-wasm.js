...
export async function defaultRipgrepWasmPath() {
    const candidates = [
...
export async function verifiedRipgrepWasm(artifactPath) {
    ...
    for (const required of ["memory", "_start"]) {
        if (!exports.has(required))
            throw new FriendlyAdversaryError(`ripgrep WebAssembly is missing export: ${required}`, 2);
    }
    return artifact;
}
//# sourceMappingURL=ripgrep-wasm.js.map